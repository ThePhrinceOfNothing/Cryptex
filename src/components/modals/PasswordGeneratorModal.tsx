    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
        <motion.div
          ...
          className="w-full max-w-md bg-white dark:bg-[#141414] border border-gray-200 dark:border-[#262626] rounded-xl shadow-2xl overflow-hidden flex flex-col"
        >
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-[#262626] bg-gray-50/50 dark:bg-black/20">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="relative">
              <div className="w-full bg-gray-100 dark:bg-black border border-gray-200 dark:border-[#262626] rounded-xl p-4 pr-24 break-all font-mono text-lg text-gray-900 dark:text-white min-h-[4rem] flex items-center">
                {password}
              </div>
          ...
          {/* Footer */}
          <div className="px-6 py-4 bg-gray-50/50 dark:bg-black/20 border-t border-gray-100 dark:border-[#262626] flex items-center justify-end">
            <button
              onClick={() => {
                onApply(password);
                onClose();
