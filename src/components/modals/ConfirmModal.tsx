    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm">
        <motion.div
          ...
          className={`w-full max-w-md bg-white dark:bg-[#141414] border rounded-xl shadow-2xl flex flex-col overflow-hidden ${
            isDestructive ? 'border-red-500/30' : 'border-gray-200 dark:border-[#262626]'
          }`}
        >
          {/* Header */}
          <div className={`flex-shrink-0 px-6 py-5 border-b bg-gray-50/50 dark:bg-black/20 ${
            isDestructive ? 'border-red-500/20' : 'border-gray-100 dark:border-[#262626]'
          }`}>
          ...
          {/* Footer */}
          <div className="px-6 py-4 bg-gray-50/50 dark:bg-black/20 border-t border-gray-100 dark:border-[#262626] flex items-center justify-end gap-3">
            <button
              onClick={onCancel}
