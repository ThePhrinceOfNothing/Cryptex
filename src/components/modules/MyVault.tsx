    ...
    <div className="flex flex-col h-full bg-white dark:bg-[#141414]">
      <div className="h-16 flex items-center justify-between px-6 border-b border-gray-200 dark:border-[#262626] shrink-0">
        ...
        <motion.button 
          ...
          whileTap={{ scale: 0.95 }}
          className="w-8 h-8 flex items-center justify-center bg-white dark:bg-[#141414] border border-gray-200 dark:border-[#262626] hover:border-accent hover:text-accent rounded-md text-gray-600 dark:text-zinc-400 transition-colors shadow-sm"
      ...
      <div className="p-4 border-b border-gray-200 dark:border-[#262626] shrink-0">
        <div className="relative">
          ...
          <input 
            ...
            className="w-full pl-9 pr-4 py-2 bg-gray-50 dark:bg-[#1e1e1e] border border-gray-200 dark:border-[#262626] rounded-md text-sm text-gray-900 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent focus:bg-white dark:bg-[#141414] transition-colors"
          />
        </div>
      </div>
            ...
            <button
              ...
              className={`w-full text-left p-3 rounded-md border flex items-center gap-3 transition-colors ${
                selectedId === cred.id 
                  ...
                  : 'bg-white dark:bg-[#141414] border-transparent hover:border-gray-200 dark:border-[#262626] hover:bg-gray-50 dark:hover:bg-zinc-900 dark:bg-[#1e1e1e]'
              }`}
            >
              <div className={`relative w-8 h-8 rounded-full flex items-center justify-center shrink-0 border overflow-hidden ${
                selectedId === cred.id ? 'bg-accent text-white border-accent' : 'bg-gray-100 dark:bg-zinc-900 text-gray-500 dark:text-zinc-500 border-gray-200 dark:border-[#262626]'
              }`}>
...
export const MyVaultDetails: React.FC<MyVaultDetailsProps> = ({ selectedId, isCreating, onSaveComplete, onDeleteComplete }) => {
  ...
  return (
    <>
      ...
      <div className="bg-white dark:bg-[#141414] border border-gray-200 dark:border-[#262626] rounded-xl p-6 shadow-sm space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-[#141414] border border-gray-200 dark:border-[#262626] rounded-md text-gray-900 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent transition-colors font-medium"
              />
            </div>
          </div>
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="https://..."
                className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-[#141414] border border-gray-200 dark:border-[#262626] rounded-md text-gray-900 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent transition-colors"
              />
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              placeholder="••••••••••••••••"
              className="w-full pl-10 pr-12 py-2.5 bg-gray-50 dark:bg-[#1e1e1e] border border-gray-200 dark:border-[#262626] rounded-md text-gray-900 dark:text-zinc-100 font-mono tracking-wider focus:bg-white dark:bg-[#141414] focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent transition-colors"
            />
            <button
        ...
        <div className="pt-2">
          ...
          <div className="relative flex gap-3">
            <input
              ...
              className="flex-1 px-4 py-2.5 bg-white dark:bg-[#141414] border border-gray-200 dark:border-[#262626] rounded-md text-gray-900 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent transition-colors font-mono text-sm"
            />
            {totpData && (
              <div className="flex items-center gap-3 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-[#262626] rounded-md px-4 py-2 shrink-0 w-40 justify-center">
              ...
              {customFields.map((field, idx) => (
                <div key={field.id} className="flex items-center gap-2">
                  <input
                    ...
                    className="w-1/3 px-3 py-2 text-sm bg-white dark:bg-[#141414] border border-gray-200 dark:border-[#262626] rounded-md text-gray-900 dark:text-zinc-100"
                  />
                  <div className="relative flex-1">
                    <input
                      ...
                      placeholder="Value"
                      className="w-full px-3 py-2 pr-10 text-sm bg-white dark:bg-[#141414] border border-gray-200 dark:border-[#262626] rounded-md text-gray-900 dark:text-zinc-100 font-mono"
                    />
                    <button
                      onClick={() => {
                        const newFields = [...customFields];
