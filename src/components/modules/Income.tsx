...
export const Income: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#fafafa] dark:bg-[#0c0c0e] overflow-hidden">
      ...
      {/* Header */}
      <div className="h-20 shrink-0 border-b border-gray-200 dark:border-[#262626] px-8 flex items-center justify-between bg-white dark:bg-[#141414]">
      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-8">
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="bg-white dark:bg-[#18181b] p-6 rounded-xl border border-gray-200 dark:border-[#262626] shadow-sm flex flex-col justify-center">
        ...
        <div className="grid grid-cols-3 gap-6 h-80">
          <div className="col-span-2 bg-white dark:bg-[#18181b] p-6 rounded-xl border border-gray-200 dark:border-[#262626] shadow-sm flex flex-col">
          ...
          <div className="col-span-1 bg-white dark:bg-[#18181b] p-6 rounded-xl border border-gray-200 dark:border-[#262626] shadow-sm flex flex-col">
        ...
        {/* Ledger Table */}
        <div className="bg-white dark:bg-[#18181b] rounded-xl border border-gray-200 dark:border-[#262626] shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-[#262626] flex items-center justify-between">
          ...
          {transactions.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-gray-50 dark:bg-[#1e1e1e] text-xs uppercase tracking-wider text-gray-500 border-b border-gray-200 dark:border-[#262626]">
                    ...
                    <tr key={tx.id} className="hover:bg-gray-50 dark:hover:bg-zinc-900/30 transition-colors group">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex gap-1 flex-wrap">
                          {tx.tags?.map(t => (
                            <span key={t} className="text-[10px] uppercase font-bold text-gray-400 border border-gray-200 dark:border-[#262626] px-1.5 py-0.5 rounded flex items-center gap-1">
                              <Tag size={8}/> {t}
                            </span>
                          ))}
                        </div>
...
const TransactionModal: React.FC<{ isOpen: boolean, onClose: () => void, tx: Transaction | null, curr: string, onSave: (t: Transaction) => void }> = ({ onClose, tx, curr, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
      ...
      <motion.div initial={{ opacity: 0, scale: 0.95, y: 10 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 10 }} className="relative w-full max-w-lg bg-white dark:bg-[#18181b] border border-gray-200 dark:border-[#262626] rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input type="number" step="0.01" value={amount} onChange={e => setAmount(e.target.value)} disabled={isSplit} className="w-full pl-8 pr-3 py-2.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-[#262626] rounded-xl text-lg font-bold text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-accent disabled:opacity-50" placeholder="0.00" />
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input type="date" value={date} onChange={e => setDate(e.target.value)} className="w-full pl-9 pr-3 py-2.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-[#262626] rounded-xl text-sm font-medium text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-accent [color-scheme:light] dark:[color-scheme:dark]" />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <input type="text" value={desc} onChange={e => setDesc(e.target.value)} className="w-full px-4 py-2.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-[#262626] rounded-xl text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-accent" placeholder="e.g. Walmart, Spotify, Salary" />
          </div>
          ...
          {!isSplit && (
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <select value={category} onChange={e => setCategory(e.target.value)} className="w-full px-4 py-2.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-[#262626] rounded-xl text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-accent">
              ...
              <div className="space-y-1.5">
                ...
                <select value={recurring} onChange={e => setRecurring(e.target.value as any)} className="w-full px-4 py-2.5 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-[#262626] rounded-xl text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-accent">
          ...
          <div className="pt-4 border-t border-gray-200 dark:border-[#262626]">
            ...
            {isSplit && (
              <div className="space-y-3 bg-gray-50 dark:bg-[#1e1e1e] p-4 rounded-xl border border-gray-200 dark:border-[#262626]">
                {splits.map((split) => (
                  <div key={split.id} className="flex items-center gap-2">
                    <select value={split.category} onChange={e => setSplits(splits.map(s => s.id === split.id ? {...s, category: e.target.value} : s))} className="flex-1 px-3 py-2 bg-white dark:bg-[#18181b] border border-gray-200 dark:border-[#262626] rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-accent">
                      <option value="Groceries">Groceries</option>
                      <option value="Dining">Dining</option>
        ...
        <div className="p-6 border-t border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-[#1e1e1e] flex justify-end gap-3 shrink-0">
