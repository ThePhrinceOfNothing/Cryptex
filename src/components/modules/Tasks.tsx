    ...
    <div className="flex h-full bg-[#fafafa] dark:bg-[#0c0c0e] relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <div className="h-20 shrink-0 border-b border-gray-200 dark:border-[#262626] px-8 flex items-center justify-between bg-white dark:bg-[#141414]">
          ...
          <div className="flex items-center gap-4 bg-gray-50 dark:bg-[#1e1e1e] p-2 rounded-xl border border-gray-200 dark:border-white/5 shadow-sm">
            <div className="flex flex-col pr-4 border-r border-gray-200 dark:border-[#262626]">
                                ...
                                <div
                                  ...
                                  className={`bg-white dark:bg-[#18181b] p-4 rounded-xl border transition-colors cursor-pointer group ${
                                    snapshot.isDragging 
                                      ...
                                      : 'border-gray-200 dark:border-[#262626] hover:border-accent/50 shadow-sm'
        ...
        {editingTask && (
          <>
            ...
            <motion.div
              ...
              className="absolute top-0 right-0 bottom-0 w-96 bg-white dark:bg-[#141414] border-l border-gray-200 dark:border-[#262626] shadow-2xl z-50 flex flex-col"
            >
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded text-xs font-bold uppercase transition-colors border ${
                          editingTask.priority === p 
                            ? PRIORITY_COLORS[p] 
                            : 'border-gray-200 dark:border-[#262626] text-gray-500 hover:bg-gray-50 dark:hover:bg-zinc-900'
                        }`}
                      >
                        {p}
                      </button>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-gray-50 dark:bg-[#1e1e1e] border border-gray-200 dark:border-[#262626] rounded-lg text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-accent [color-scheme:light] dark:[color-scheme:dark]"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full h-32 bg-gray-50 dark:bg-[#1e1e1e] border border-gray-200 dark:border-[#262626] rounded-lg p-3 text-sm focus:outline-none focus:ring-1 focus:ring-accent resize-none"
