  ...
  return (
    <div className="flex flex-col h-full bg-white">
      <div className="h-16 flex items-center justify-between px-6 border-b border-gray-200 shrink-0">
        <h2 className="font-semibold text-gray-900">Secure Notes</h2>
        <motion.button 
          onClick={onCreateNew}
          ...
          filteredNotes.map(note => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className={`font-medium text-sm truncate ${selectedId === note.id ? 'text-accent' : 'text-gray-900'}`}>
    ...
    <div className="flex flex-col h-full bg-white relative">
      ...
      <div className="flex-1 flex flex-col max-w-4xl w-full mx-auto p-10 pt-16">
        <input
          ...
          className="w-full text-4xl font-bold text-gray-900 bg-transparent border-none focus:outline-none focus:ring-0 placeholder-gray-300 mb-2"
        />
        ...
        {/* Formatting Toolbar */}
        {editor && (
          <div className="flex flex-wrap items-center gap-1 mb-4 p-1.5 bg-gray-50 border border-gray-200 rounded-lg shrink-0">
            <button
              onClick={() => editor.chain().focus().toggleBold().run()}
              className={`p-1.5 rounded transition-colors ${editor.isActive('bold') ? 'bg-white text-accent shadow-sm' : 'text-gray-500 hover:bg-gray-200 hover:text-gray-900'}`}
              title="Bold"
            >
              <Bold size={16} />
            </button>
            <button
              ...
              className={`p-1.5 rounded transition-colors ${editor.isActive('italic') ? 'bg-white text-accent shadow-sm' : 'text-gray-500 hover:bg-gray-200 hover:text-gray-900'}`}
              title="Italic"
            >
              <Italic size={16} />
            </button>
            ...
            <button
              ...
              className={`p-1.5 rounded transition-colors ${editor.isActive('heading', { level: 1 }) ? 'bg-white text-accent shadow-sm' : 'text-gray-500 hover:bg-gray-200 hover:text-gray-900'}`}
              title="Heading 1"
            >
              <Heading1 size={16} />
            </button>
            <button
              ...
              className={`p-1.5 rounded transition-colors ${editor.isActive('heading', { level: 2 }) ? 'bg-white text-accent shadow-sm' : 'text-gray-500 hover:bg-gray-200 hover:text-gray-900'}`}
              title="Heading 2"
            >
              <Heading2 size={16} />
            </button>
            ...
            <button
              ...
              className={`p-1.5 rounded transition-colors ${editor.isActive('bulletList') ? 'bg-white text-accent shadow-sm' : 'text-gray-500 hover:bg-gray-200 hover:text-gray-900'}`}
              title="Bullet List"
            >
              <List size={16} />
            </button>
            <button
              ...
              className={`p-1.5 rounded transition-colors ${editor.isActive('orderedList') ? 'bg-white text-accent shadow-sm' : 'text-gray-500 hover:bg-gray-200 hover:text-gray-900'}`}
              title="Ordered List"
            >
              <ListOrdered size={16} />
            </button>
            ...
            <button
              ...
              className={`p-1.5 rounded transition-colors ${editor.isActive('blockquote') ? 'bg-white text-accent shadow-sm' : 'text-gray-500 hover:bg-gray-200 hover:text-gray-900'}`}
              title="Blockquote"
            >
              <Quote size={16} />
            </button>
            <button
              ...
              className={`p-1.5 rounded transition-colors ${editor.isActive('codeBlock') ? 'bg-white text-accent shadow-sm' : 'text-gray-500 hover:bg-gray-200 hover:text-gray-900'}`}
              title="Code Block"
            >
              <Code size={16} />
            </button>
