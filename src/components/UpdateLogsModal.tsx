      ...
      {isOpen && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm">
          <motion.div
            ...
            className="w-full max-w-2xl bg-white dark:bg-[#121214] border border-gray-200 dark:border-white/10 rounded-2xl shadow-2xl flex flex-col overflow-hidden max-h-[85vh]"
          >
            {/* Header */}
            <div className="flex-shrink-0 px-6 py-5 border-b border-gray-100 dark:border-white/10 bg-gray-50/50 dark:bg-black/20">
            ...
            >
              <div className="prose prose-sm dark:prose-invert max-w-none">
                ...
                <div className="h-12 border-t border-dashed border-gray-200 dark:border-white/10 mt-8 pt-8 flex items-center justify-center text-sm text-gray-400 dark:text-zinc-600 font-medium">
            ...
            {/* Footer / Actions */}
            <div className="flex-shrink-0 px-6 py-4 border-t border-gray-100 dark:border-white/10 bg-white dark:bg-[#0c0c0e] flex flex-col sm:flex-row items-center justify-between gap-4">
