  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh]">
      ...
      <motion.div
        ...
        className="relative w-full max-w-xl bg-white dark:bg-[#141414] rounded-xl shadow-2xl border border-gray-200 dark:border-[#262626] overflow-hidden flex flex-col"
      >
        <div className="flex items-center px-4 border-b border-gray-200 dark:border-[#262626]">
                      ...
                      >
                        <div className={`w-8 h-8 rounded-full border flex items-center justify-center shrink-0 ${
                          isSelected
                            ...
                            : 'bg-white dark:bg-[#141414] border-gray-200 dark:border-[#262626]'
                        }`}>
                        ...
                        <span className="text-[10px] text-gray-400 uppercase tracking-widest bg-gray-50 dark:bg-[#1e1e1e] border border-gray-200 dark:border-[#262626] px-1.5 py-0.5 rounded">
                          {r.type}
                        </span>
                      </button>
                    </li>
        ...
        <div className="px-4 py-2 bg-gray-50 dark:bg-[#1e1e1e] border-t border-gray-200 dark:border-[#262626] text-xs text-gray-500 dark:text-zinc-500 flex items-center justify-between">
          <div className="flex gap-4">
            <span className="flex items-center gap-1"><kbd className="px-1 py-0.5 bg-white dark:bg-[#141414] border border-gray-300 dark:border-white/20 rounded shadow-sm text-[10px] font-sans">↑↓</kbd> to navigate</span>
            <span className="flex items-center gap-1"><kbd className="px-1 py-0.5 bg-white dark:bg-[#141414] border border-gray-300 dark:border-white/20 rounded shadow-sm text-[10px] font-sans">Enter</kbd> to select</span>
            {results[selectedIndex]?.type === 'credential' && (
              <span className="flex items-center gap-1 text-accent"><kbd className="px-1 py-0.5 bg-white dark:bg-[#141414] border border-blue-300 dark:border-blue-900/50 rounded shadow-sm text-[10px] font-sans text-accent">Ctrl+C</kbd> to copy password</span>
            )}
            {results[selectedIndex]?.type === 'calculator' && (
              <span className="flex items-center gap-1 text-accent"><kbd className="px-1 py-0.5 bg-white dark:bg-[#141414] border border-blue-300 dark:border-blue-900/50 rounded shadow-sm text-[10px] font-sans text-accent">Enter</kbd> to copy</span>
            )}
          </div>
          <span className="flex items-center gap-1"><kbd className="px-1 py-0.5 bg-white dark:bg-[#141414] border border-gray-300 dark:border-white/20 rounded shadow-sm text-[10px] font-sans">Esc</kbd> to close</span>
        </div>
      </motion.div>
    </div>
  );
