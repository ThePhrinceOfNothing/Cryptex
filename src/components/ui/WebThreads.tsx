...
export const WebThreads = ({
  ...
  useEffect(() => {
    ...
    const c1 = u.uColor1.value; const rgb1 = hexToRgb(color1); c1[0] = rgb1[0]; c1[1] = rgb1[1]; c1[2] = rgb1[2];
    const c2 = u.uColor2.value; const rgb2 = hexToRgb(color2); c2[0] = rgb2[0]; c2[1] = rgb2[1]; c2[2] = rgb2[2];
    const c3 = u.uColor3.value; const rgb3 = hexToRgb(color3); c3[0] = rgb3[0]; c3[1] = rgb3[1]; c3[2] = rgb3[2];
    const bg = u.uBackgroundColor.value; const rgbBg = hexToRgb(backgroundColor); bg[0] = rgbBg[0]; bg[1] = rgbBg[1]; bg[2] = rgbBg[2];
